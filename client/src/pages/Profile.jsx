...
export default function Profile() {
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
        ...
        <p className='text-sm self-center'>
          {
            ...
            filePercentage === 100 ? (<span className='text-blue-700'>Image successfully uploaded!</span>) : ""
          }
        </p>
        <input
          type="text"
      ...
      <p className='text-red-700 mt-5 mx-auto'>{error ? error : ""}</p>
      <p className='text-green-700 mt-5 mx-auto'>{updateSuccess ? 'User is updated successfully!' : ""}</p>
